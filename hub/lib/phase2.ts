...
export const PHASE2_REQUIREMENT_AUDIT: RequirementAuditItem[] = [
  ...
  { id: "P2-ASK", requirement: "Ask-the-Hub agent over HubSpot + Supabase + Open Data.", status: "partial", evidence: "Role-aware Ask-the-Hub route, Help console, Anthropic synthesis when configured, deterministic fallback, Open Data context, graph trace/eval rows, and privacy refusals exist; persisted DB ask audit and full live aggregate adapter remain deferred." },
