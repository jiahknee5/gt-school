...
export const PHASE2_REQUIREMENT_AUDIT: RequirementAuditItem[] = [
  ...
  { id: "P2-ASK", requirement: "Ask-the-Hub agent over HubSpot + Supabase + Open Data.", status: "partial", evidence: "Role-aware Ask-the-Hub route, Help console, cited deterministic agents, Open Data decision context, and privacy refusals exist; live LLM summarization and persisted ask audit remain deferred." },
