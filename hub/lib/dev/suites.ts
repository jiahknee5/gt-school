...
export const SUITES: Suite[] = [
  ...
  },
  {
    ...
    files: [
      ...
      { file: "tests/ask-agents.test.ts", kind: "pure", needs: [], what: "Ask-the-Hub deterministic fallback, provider synthesis, de-identified context, Open Data decision impact, and safe refusals." },
      { file: "tests/ask-evals.test.ts", kind: "pure", needs: [], what: "Ask-the-Hub graph trace rows, expected-vs-actual evals, citations, and deterministic eval suite." },
      { file: "tests/decisions.test.ts", kind: "pure", needs: [], what: "Decision Queue ruling transitions and Leader-only mutation route." },
      { file: "tests/decisions-raise.test.ts", kind: "pure", needs: [], what: "Any-role decision raises, submitter cookies, validation, and Leader-only queue regression guard." },
