      ...
      >
        <div className="space-y-2.5">
          {scoring.histogram.map((b) => (
            <div key={b.label} className="grid grid-cols-[64px_1fr_48px] items-center gap-3">
        ...
        <div className="divide-y divide-hairline">
          {scoring.tiers.map((t) => (
            <div key={t.tier} className="grid gap-2 py-3 sm:grid-cols-[1fr_100px_100px] sm:items-center">
              <p className="text-[13px] font-semibold text-ink">{t.tier}</p>
              <span className="mono text-[12px] text-muted">{t.count} families</span>
      ...
      <Card title="Score to conversion (correlation)" note={scoring.correlation.caveat}>
        <div className="grid gap-3 sm:grid-cols-3">
          <div className="rounded-card border border-hairline bg-canvas p-3">
            ...
            <p className="mono num mt-1 text-[20px] font-semibold text-ink">
