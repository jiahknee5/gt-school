...
const CATEGORY_TINT: Record<string, string> = {
  "Run the cadence": "bg-blue-soft text-blue",
  "Grow the funnel": "bg-green-soft text-green",
  "Close the loop": "bg-violet-soft text-violet",
  "Govern & trust": "bg-amber-soft text-amber",
          ...
          <div className="mt-4 grid grid-cols-1 gap-3.5 lg:grid-cols-2">
            {group.guides.map((g) => (
              ...
              >
                ...
                <p className="mt-2 flex-1 text-[13px] leading-relaxed text-muted">{g.objective}</p>
                ...
                {g.fromSpec && (
                  <p className="mono mt-3 text-[10px] uppercase tracking-[0.08em] text-green">From the spec</p>
                )}
              </Link>
            ))}
          </div>
